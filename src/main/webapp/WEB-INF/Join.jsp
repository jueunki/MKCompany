...
<header class="h1">
	...
	<div class="midbox">
		...
		<span style="color:#0054a6;">SIGN</span>&nbsp;<span>UP</span>&nbsp;<span style="color:#aaa; font-size:0.9rem;">회원가입약관 및 개인정보처리방침</span>
		</h3>
 ...
 <br>
     이 약관은 2018년 11월 15일부터 시행합니다.</div>
		...
		<br> 
		<div style=" border-radius:3px;  text-align:center; position:absolute; width:8.5vw; height:1.8vh; padding:1.5%; margin:1%; right:43%; top:132%; border:1px solid #0054a6; background-color:#0054a6;"><a href="/Joinus.do" style="position:relative; color:white; font-weight:600; font-size:0.9rem; top:-20%;"><!-- <input type=submit value=회원가입> -->회원가입</a></div>
	</main>

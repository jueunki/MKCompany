...
%>
	...
	<div class="siteK">
		...
		<span style="font-size: 0.9rem;"><a href="/main.do">🏠</a>> 사이트
			> 로그인</span>
	</div>
	<main class="m1">
		<div class="midbtn">
			...
			<div>
				...
				<form action="/Login.do" method="post">
					<input name="id" class="idbox"
						style="border: 1px solid #e1e1e1 !important; border-radius: 3px; width: 65%; padding: 4%; margin: 1%;"
						placeholder="아이디"> <br> <input name="pwd" class="pwdbox"
						style="border: 1px solid #e1e1e1 !important; border-radius: 3px; width: 65%; padding: 4%; margin: 1%;"
						placeholder="비밀번호"> <br>
					<div
						style="left: 20%; width: 30%; position: relative; left: 61%; color: gray;">
						<input type="checkbox">자동로그인
					</div>
					<br>
					<div>
						<a href="#"><input type="submit" value="로그인"
							style="width: 75%;  cursor:pointer; border: 1px solid #0054a6; background-color: #0054a6; border-radius: 3px; padding: 4%; margin: 1%; color: white; font-weight: 600;"></a>
					</div>
				</form>
				...
				<div class="midbox2"
					style="border: 1px solid #e1e1e1; border-radius: 3px; background-color: #f5f6f8; position: absolute; width: 22.4vw; height: 8vh; left: 12.5%; top: 75%;">
					<div style="width: 7vw; position: relative; top: 20%;">
						<img id="bnr_logo" src="/Img/banner/bnr_img1.png"
							style="width: 4.7vw; height: 5vh;">
					</div>
					<div
						style="width: 15vw; position: relative; left: 30%; top: -50%; font-size: 0.8rem;">
						<span style="color: #0054a6;">현대이지웹</span><span
							style="font-weight: 600; color: #0054a6;">1544-6062</span><br>
